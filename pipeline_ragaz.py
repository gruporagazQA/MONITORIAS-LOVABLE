...
================================================================================
 ...
 USO (PowerShell):
   ...
   python "...\pipeline_ragaz.py"

   # Mês específico
   python "...\pipeline_ragaz.py" --mes 2026-07

   # Pular fases 1 e 2 (downloads já feitos)
   python "...\pipeline_ragaz.py" --fases 3,4,5
   ...
   python "...\pipeline_ragaz.py" --agendar --hora 07:00
